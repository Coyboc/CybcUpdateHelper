 ...
 */
public abstract class UpdateHelperBase<UpdateImpl extends Update<StorageToUpdate>, StorageToUpdate> {

    private final UpdateWorker<UpdateImpl, StorageToUpdate> updatable;

    /**
     * Creates a new {@link UpdateHelperBase} for the given {@link UpdateWorker}. The Helper will collect the needed information from the {@link UpdateWorker} for the updates.
     *
     * @param updatable
     *         the object (in most cases a database instance) to update.
     */
    public UpdateHelperBase(UpdateWorker<UpdateImpl, StorageToUpdate> updatable) {
